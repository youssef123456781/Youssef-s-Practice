...
addBtn.addEventListener("click", function(){
        if (userinput.value){
                ...
                userinput.value = ""
                savedValueAmount = document.querySelectorAll<HTMLInputElement>(`.container input`).length
                ...
                for(let i = 0; i < 100; i++){
                        ...
                        if(checkbox){
                                ...
                                const checked = document.querySelectorAll<HTMLInputElement>(`.container input:checked`).length
                                const unchecked = document.querySelectorAll<HTMLInputElement>(`.container input`).length - checked
        ...
        for(let i = 0; i < 100; i++){
                ...
                if(deleteBtn){
                        deleteBtn.addEventListener("click", function(){
                                document.getElementById(`listItem${i}`)?.remove()
                                const checked = document.querySelectorAll<HTMLInputElement>(`.container input:checked`).length
                                const unchecked = document.querySelectorAll<HTMLInputElement>(`.container input`).length - checked
                                uncheckedAmount.innerText = unchecked.toString()
                                checkedAmount.innerText = checked.toString()
...
deleteAllBtn.addEventListener("click", function(){
        ...
        savedValueAmount = 0
        const checked = document.querySelectorAll<HTMLInputElement>('#checkboxes input:checked').length
